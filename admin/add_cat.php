...
if (isset($_POST['add_cat'])) {
	...
	$sql="SELECT * FROM categories WHERE cat_name='{$cat_name}'";	// category check krne ke liye query banani hai 
	...
	// agar category exist nhi krti hai to to bna de to datbase me save kr de 
	else
	{
