...
// how much we want on page  
$limit=5;

$offset=($page-1)*$limit;
// page pr data lene ke liye query me limit lagate hai with offset and limit 
// -------------------
...
<div class="row">
	<div class="col-lg-8">
		...
		<?php 
			...
			// agar post hi limit ke barabar ho to pagination display na ho iske liye condition  
			if($total_post > $limit) {
		?>
		<ul class="pagination pt-2 pb-5">
			...
			<li class="page-item <?= ($i==$page) ? "active":"";?>">
				<a href="index.php?page=<?= $i ?>" class="page-link"> <!--url me  page no dene ke liye   -->
					<?= $i ?> <!-- page show krta hai kitne bane hai   -->
				</a>
			</li>
			<?php 
				} 
